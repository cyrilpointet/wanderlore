...
- **Environnement de dev et de tests locaux sous Docker** : conteneurs PostgreSQL et Redis, pour un environnement reproductible dès la Phase 0 (Redis nécessaire dès cette phase en prévision de BullMQ, introduit en Phase 2).
